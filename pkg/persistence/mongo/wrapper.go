...
// Collection is an interface for MongoDB collection operations with automatic timeout
...
// CollectionWrapper wraps MongoDB collection and automatically adds query timeout to all operations
type CollectionWrapper struct {
	coll    *mongodriver.Collection
	timeout time.Duration
}

// NewCollectionWrapper creates a new wrapper with automatic timeout handling
func NewCollectionWrapper(coll *mongodriver.Collection, timeout time.Duration) *CollectionWrapper {
